...
On the data generation side, we were able to generate the data itself with little problem.  Credit goes to Andy for his use and editing of Stata to provide this solution.
